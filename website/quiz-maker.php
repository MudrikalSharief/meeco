...
<nav class="navbar">
    ...
    <main>
            ...
            <div class="container">
                <div class="content-split">
                    <div class="text-content">
                        ...
                        <p style="padding-top:30px; margin-bottom: 4px;"><img src="pictures/check.png" alt="check" class="check"></span>Quiz name</span></p>
                        <p style="margin-bottom: 4px;"><img src="pictures/check.png" alt="check" class="check"></span>Number of Questions</span></p>
                    </div>
                    <div class="image-content">
                        <img src="pictures/convert-image-6.png" alt="level-up" class="convert-image-meeco">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="content-split">
                    <div class="text-content">
                        ...
                        <button class="btn-subtitle">Learn more</button>
                        <p style="padding-top:30px; margin-bottom: 4px;"><img src="pictures/check.png" alt="check" class="check"></span>Multiple choice</span></p>
                        <p style="margin-bottom: 4px;"><img src="pictures/check.png" alt="check" class="check"></span>Number of Questions</span></p>
                        <p style="margin-bottom: 4px;"><img src="pictures/check.png" alt="check" class="check"></span>True or False</span></p>
                        <p style="margin-bottom: 4px;"><img src="pictures/check.png" alt="check" class="check"></span>Mixed</span></p>
                    </div>
                    <div class="image-content">
                        <img src="pictures/convert-image-7.png" alt="level-up" class="convert-image-meeco">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="how-it-works">
            <div class="container">
                <h2 class="text-how-it-works"><img src="pictures/sparkling.png" alt="sparkle" class="sparkle"></span> <span class="highlight-blue">Explore more features</span><img src="pictures/sparkling.png" alt="sparkle" class="sparkle"></span></h2>
